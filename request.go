...
type Request struct {
	...
	// like an *hclient.Request so that all meta methods are supported.
	*http.Request
...
// WithContext returns wrapped Request with a shallow copy of underlying *hclient.Request
...
// FromRequest wraps an hclient.Request in a retryablehttp.Request
...
// FromRequestWithTrace wraps an hclient.Request in a retryablehttp.Request with trace enabled
...
// hclient.Request's Body variable, but it returns a copy of the underlying data
