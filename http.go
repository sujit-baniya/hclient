...
// DefaultClient returns a new hclient.Client with similar default values to
...
// DefaultPooledClient returns a new hclient.Client with similar default values to
